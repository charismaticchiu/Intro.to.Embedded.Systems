      ...
      000002 75 30 00         [24]  311 	mov	_SWcounter,#0x00
                                    312 ;	hw6timer.c:26: InitTimer();	
      000005 12 00 12         [24]  313 	lcall	_InitTimer
                                    314 ;	hw6timer.c:27: while (1) {
      000008                        315 00102$:
                                    316 ;	hw6timer.c:28: PollTimer();
      000008 12 00 1B         [24]  317 	lcall	_PollTimer
                                    318 ;	hw6timer.c:29: tick=0;
      00000B C2 00            [12]  319 	clr	_tick
                                    320 ;	hw6timer.c:30: SWcounter=0;
      00000D 75 30 00         [24]  321 	mov	_SWcounter,#0x00
      ...
      00001E 12 00 29         [24]  350 	lcall	_HandleRollover
